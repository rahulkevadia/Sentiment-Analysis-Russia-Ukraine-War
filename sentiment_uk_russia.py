...
csv_collection = []
for dirname, _, filenames in os.walk('C:\\Users\\Rahul\\Desktop\\Projects\\Sentiment-Analysis-Russia-Ukraine-War\\archive.zip'):
...
ru_eng_clean.to_csv("C:\\Users\\Rahul\\Desktop\\Projects\\Sentiment-Analysis-Russia-Ukraine-War\\archive\\ru_2_en.csv",sep=",",index=False)

ru_eng_df = pd.read_csv("C:\\Users\\Rahul\\Desktop\\Projects\\Sentiment-Analysis-Russia-Ukraine-War\\archive\\ru_2_en.csv")
...
# http://en.wiktionary.org/wiki/Category:English_degree_adverbsgit
